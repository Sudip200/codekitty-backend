...
const chrome_ai_1 = require("@langchain/community/experimental/chat_models/chrome_ai");
const tiktoken_1 = require("@langchain/core/utils/tiktoken");
const model = new chrome_ai_1.ChatChromeAI();
...
inputForm.addEventListener("submit", async (event) => {
    ...
    const encoding = await (0, tiktoken_1.encodingForModel)("gpt2");
